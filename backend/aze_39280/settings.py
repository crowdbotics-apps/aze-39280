"""
Django settings for aze_39280 project.
...
WSGI_APPLICATION = 'aze_39280.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "aze_39280 API",
    "DESCRIPTION": "API documentation for aze_39280 App",
    "VERSION": "v1",
}
